  ...
  const seasonalActivities = [
    {
      ...
      period: 'Tháng 10 2022 - Tháng 11 2022',
    ...
    },
    {
      ...
      period: 'Tháng 1 2021 - Tháng 7 2021',
      description: 'Hoạt động thể dục và cân bằng cho thú cưng.',
    },
  ]

  return (
    <section id="curriculum" className="section-padding bg-gradient-to-br from-green-50 to-green-100 relative overflow-hidden">
      ...
      <div className="container-custom">
        ...
        {/* Core Activities */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold mb-8 text-center">Hoạt Động Cốt Lõi</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreActivities.map((activity, index) => (
              <div
                key={index}
                className="bg-white rounded-xl p-6 hover:shadow-lg transition-shadow relative overflow-hidden border-2 border-green-200"
              >
                {/* Jagged decorative element */}
                ...
                <h4 className="text-xl font-semibold mb-3 relative z-10">{activity.title}</h4>
        ...
        <div>
          ...
          <p className="text-center text-gray-600 mb-8 max-w-3xl mx-auto">
            ...
            Những hoạt động này được thiết kế với sức khỏe của thú cưng trong tâm trí.
          </p>
