...
export default function Services() {
  ...
  return (
    <section id="services" className="section-padding bg-gradient-to-br from-brown-50 to-brown-100 relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <Link href="#contact" className="bg-brown-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-brown-700 transition-all duration-200 transform hover:scale-105 active:scale-95 w-full text-center block">
                Tìm Hiểu Thêm
              </Link>
            </div>
          ))}
